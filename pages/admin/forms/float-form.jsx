...
export default function MobileAppForms() {
  ...
  const fetchSubmissions = useCallback(async (page = 1) => {
    ...
    setError(null);
    try {
      let url = `/api/admin/forms/floatform-submissions?page=${page}&limit=10`;
      ...
      <FormAdmin>
        <div className="container mx-auto p-4">
          <div className="flex justify-between items-center mb-6">
            <h2 className="font-bold p-2">Float Form Submissions</h2>
                      ...
                      {submissions.length > 0 ? (
                        submissions.map((submission) => (
                          <tr key={submission.id || submission.submission_date}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{submission.req}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{submission.others}</td>
