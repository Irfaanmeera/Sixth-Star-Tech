...
export default function MobileAppForms() {
  ...
  const fetchSubmissions = useCallback(async (page = 1) => {
    ...
    setError(null);
    try {
      let url = `/api/admin/forms/serversform-submissions?page=${page}&limit=10`;
      ...
      <FormAdmin>
        <div className="container mx-auto p-4">
          <div className="flex justify-between items-center mb-6">
            <h2 className="font-bold p-2">Servers Form Submissions</h2>
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                      <tr>
                        ...
                        <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Control Panel</th>
                      ...
                      {submissions.length > 0 ? (
                        submissions.map((submission) => (
                          <tr key={submission.id || submission.submission_date}>
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{submission.core}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{submission.sla}</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{submission.controlpanel}</td>
