...
// IMPORTANT: We check if the password variable exists, but we don't print it for security.
console.log("Is Password defined?", typeof process.env.DB_PASSWORD !== 'undefined');
console.log("Is Password empty?", process.env.DB_PASSWORD === '');
console.log("-----------------------------------------");
// --- END DEBUGGING BLOCK ---

const dbPort = process.env.DB_PORT ? parseInt(process.env.DATABASE_PORT, 10) : 3306;
