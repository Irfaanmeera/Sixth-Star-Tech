      ...
      <div className="container mx-auto px-4">
        <div className="row mb-3 fullstack-resource">
          <div className="col-12">
            <h3 className="text-3xl font-bold text-gray-800">Full Stack Development Resources</h3>
          </div>
        </div>
            ...
            <Slider {...sliderSettings} className="">
              {posts.map((post) => (
                <div key={post.id} className="px-2 " >
                  <div className="box bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg hover:scale-102 transition-transform duration-300">
