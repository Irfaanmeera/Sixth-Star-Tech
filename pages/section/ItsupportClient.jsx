...
const ItSupportClient = () => {
    const settings = {
        infinite: true,
        slidesToShow: 2, // Default for desktop view
        slidesToScroll: 1,
        autoplay: true,
        speed: 2000,
        autoplaySpeed: 2000,
        ...
        responsive: [
            {
                ...
                settings: {
                    slidesToShow: 1, // Show 3 slides for tablet-sized screens
                }
            },
            {
            ...
            <Slider {...settings}>
                {logos.map((logo, index) => (
                    <div key={index} className="container">
                        <img src={logo} alt='client img' width={224} height={109} loading='lazy' />
                    </div>
                ))}
            </Slider>
        </div>
...
export default ItSupportClient;
