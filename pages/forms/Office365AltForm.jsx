...
import { officeAltContactForm } from '../../lib/api'; // Adjust the import path accordingly

const initState = { values: {}, isLoading: false }; // Initialize values properly

const Office365AltForm = () => {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await officeAltContactForm(formData);
...
export default Office365AltForm;
