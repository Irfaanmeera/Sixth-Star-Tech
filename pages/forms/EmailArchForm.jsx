...
import { emailarchContactForm } from '../../lib/api'; // Adjust the import path accordingly
...
const EmailArchForm = () => {
  ...
  const onSubmit = async (event) => {
    ...
    try {
      await emailarchContactForm(formData);
