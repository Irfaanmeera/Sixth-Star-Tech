...
export default function DedicatedServerDelhi() {
...
<div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
  ...
  <div className="row gx-6 ">
    ...
    <AnimatedHeading className='server heading'>FAST AND ROBUST DEDICATED SERVER HOSTING IN DELHI</AnimatedHeading>
            <p className='ser-para'>Sixth Star Technologies offer dedicated server hosting in Delhi with maximum flexibility from small vendors to medium sized business partners for their specific day-to-day operations. We package our servers with maximum add-ons to meet your exact needs with best offers. We have a wide variety of dedicated servers and we will choose the best plan for you by knowing your IT requirements through comprehensive inquiry.</p>    
    </div>
  ...
  <div className="row gx-6">
    ...
    <div className="price col-lg-3 col-md-6 text-center">
      ...
      <Link href='#dedicateddelhicontact' className='price-but'>Contact now</Link>
    </div>
  ...
  <div className="row gx-6 ">
    ...
    <div className="col-12">
    <AnimatedHeading className='server heading'>BENEFITS OF DEDICATED SERVER HOSTING</AnimatedHeading>
    </div>
    ...
    <h3> Accessibility</h3>
    <p>Full root access and server administration is been given to the client for managing their private databases with own configurations.</p>
    </div>
    <div className="col-lg-4 col-md-12 p-3 m-3 text-center benefit">
    ...
    <h3> Uptime</h3>
    <p>With level best hardware and software features, we are providing runtime guarantee with 99.9% uptime under our domain.</p>
    </div>
    <div className="col-lg-4 col-md-12 p-3 m-3 text-center benefit">
    <Image src="https://res.cloudinary.com/dwyn5jgh3/image/upload/v1722402975/reliability_xjqayp.webp" width={64} height={64} alt='Reliability' loading='lazy'/> 
    <h3> Reliability</h3>
    <p>We will be adhered in providing the best security for securing your private data’s and also we provide the best redundant source for full-time performance.</p>
    </div>
    ...
    <p>We provide your servers with the best competitive prices in the market with resourceful availabilities.</p>
    </div>
    <div className="col-lg-4 col-md-12 p-3 m-3 text-center benefit">
    <Image src="https://res.cloudinary.com/dwyn5jgh3/image/upload/v1722420095/backup_grm769.webp" width={64} height={64} alt='Backup And Setup' loading='lazy'/> 
    <h3>Backup And Setup</h3>
    <p>We provide setup and installation and also backup your data and hardware with free of cost.</p>
    </div>
    <div className="col-lg-4 col-md-12 p-3 m-3 text-center benefit">
    ...
    <p>We will be available to hear you in any instance to clear your queries through live chats or phone calls.</p>
    </div>
    </div>
...
<div className="container">
  <div className="row justify-content-center c2a container">
    ...
    <div className="col-md-6 ">
    <Link href="#dedicateddelhicontact">Contact us</Link>
    </div>
...
<div className="container p-3">
  ...
  <div className="row justify-content-center">
    ...
    <div className="row">
      ...
      <ul>
      <li> <i className="fa-solid fa-check"></i> <p>We help you to start, intensify or relocate your hosting according to your needs.</p></li>
...
<div className="container">
  <div className="row ">
    ...
    <div className="col-md-6" id='dedicateddelhicontact'>
    <ServersForm />
    </div>
