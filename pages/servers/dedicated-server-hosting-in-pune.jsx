...
export default function DedicatedServerPune() {
  ...
  <div className="row">
    ...
    <div className="ban-left-1 col-md-6">
        <h1 className='server-1 box-up'>Dedicated Server Hosting in Pune</h1>
        <div >
...
<div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
  ...
  <div className="row gx-6 ">
    ...
    <AnimatedHeading className='server heading'>FAST AND ROBUST DEDICATED SERVER HOSTING IN PUNE</AnimatedHeading>
            <p className='ser-para'>We provide exclusive dedicated server hosting in Pune with resourceful facilities and high performing servers. Once the server is been given to the client they can have complete control servers with root/administrator access. You can choose our servers from Linux and Windows plans featuring high-reliability disks, multicore processors, spare disks, redundant network configuration and power supply.</p> 
            <p>We also provide Firewalls and encryption method for your security purposes. If you are in need of extra RAM storage, our sales team will be keen to discuss the details with you.</p>
    </div>
  ...
  <div className="row gx-6">
    ...
    <div className="price col-lg-3 col-md-6 text-center">
      ...
      <Link href='#dedicatedpunecontact' className='price-but'>Contact now</Link>
    </div>
...
<div className="container">
  <div className="row justify-content-center c2a container">
    ...
    <div className="col-md-6 ">
    <Link href="#dedicatedpunecontact">Contact us</Link>
    </div>
...
<div className="container">
  <div className="row ">
    ...
    <div className="col-md-6" id='dedicatedpunecontact'>
    <ServersForm />
    </div>
